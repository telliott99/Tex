...
One simple form of related rates problem involve two objects moving at right angles from each other, with positions and speeds given in terms of the origin.  For example:
