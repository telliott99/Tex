...
I thought I would work on the derivations of some of the integrals shown in standard tables.  Here is what I have so far.  Each one of the following will come in three versions [ A:  ($x^2 + 1$), B:  ($x^2 - 1$), C:  ($1 - x^2$) ].  Let's group them as follows:
