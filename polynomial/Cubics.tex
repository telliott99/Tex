...
There is an axis of symmetry, here at $x = 1$, and the left half is the negative reflection of the right half about the value of $y = f(x) = 0$.
...
Not all cubics have a downward sloping segment.  This happens when the quadratic for the slope has no real roots, i.e. when the square root term is less than zero.  A simple example of this is when $b = 0$, such as
\[ y = x^3 \]
